      ...
      body: SafeArea(
        child: Center(
          child: SingleChildScrollView(
            ...
            const Text('How will you use KiloTap?',
                style: TextStyle(
                    fontSize: 18,
                ...
                child: Row(children: [
                  ...
                  const Expanded(
                      child: Column(
                          ...
                          children: [
                        Text('I want to sell scrap',
                            style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.w700,
                                color: AppColors.textPrimary)),
                        SizedBox(height: 2),
                        Text('Household — list recyclables for pickup',
                            style: TextStyle(
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(16),
                    border: Border.all(
                        color: AppColors.buyerBlue.withOpacity(0.3), width: 2)),
                child: Row(children: [
                  Container(
                      width: 52,
                      height: 52,
                  ...
                  const Expanded(
                      child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                        Text('I want to collect scrap',
                            style: TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.w700,
                                color: AppColors.textPrimary)),
                        SizedBox(height: 2),
                        Text('Collector — pick up scrap and earn',
                            style: TextStyle(
                                fontSize: 12, color: AppColors.textSecondary)),
                      ])),
