            ...
            children: [
              ...
              Container(
                  ...
                  child: Stack(children: [
                    Positioned(
                        top: 90,
                        left: 140,
                        child: _RStop('1', AppColors.success, done: true)),
                    Positioned(
                        top: 60,
                        left: 200,
                        child: _RStop('2', AppColors.buyerBlue, current: true)),
                    Positioned(
                        top: 140,
                        left: 180,
                        child: _RStop('3', AppColors.buyerBlue)),
                    Positioned(
                        top: 30,
                        left: 260,
              ...
              Container(
                  ...
                  child: Column(children: [
                    Row(children: [
                      _Sum('4.7 km', 'Distance'),
                      _Sum('2.5 hrs', 'Est. Time')
                    ]),
...
class _RStop extends StatelessWidget {
  final String num;
  final Color color;
  final bool done, current;
  const _RStop(this.num, this.color, {this.done = false, this.current = false});
  @override
...
class _StopCard extends StatelessWidget {
  final String num, name, detail, status;
  final bool done, current;
  const _StopCard(this.num, this.name, this.detail, this.status,
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(
            ...
            border: Border.all(
                color: current ? AppColors.buyerBlue : AppColors.divider)),
        child: Row(children: [
          Container(
              width: 28,
              height: 28,
          ...
          if (status.isNotEmpty)
            Text(status,
                style: TextStyle(
                    fontSize: 9,
                    fontWeight: FontWeight.w700,
                    color: done ? AppColors.success : AppColors.buyerBlue)),
        ]),
      );
}
