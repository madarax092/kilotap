...
class ChatHouseholdsScreen extends StatefulWidget {
  ...
  @override
  State<ChatHouseholdsScreen> createState() => _ChatHouseholdsScreenState();
}

class _ChatHouseholdsScreenState extends State<ChatHouseholdsScreen> {
  ...
  Future<void> _send() async {
    ...
    _controller.clear();
    await _service.sendMessage(AuthState.instance.uid, widget.householdUid, text);
  }
          ...
          Expanded(
            child: StreamBuilder<List<Message>>(
              stream: _service.messagesBetween(
                  AuthState.instance.uid, widget.householdUid),
