      ...
      body: Stack(
        ...
        children: [
          ...
          if (_showBoundingBoxes) ...[
            _BoundingBox(left: 40, top: 120, width: 150, height: 250, label: 'Refrigerator', color: AppColors.sellerGreen),
            _BoundingBox(left: 220, top: 300, width: 40, height: 80, label: 'Plastic', color: Colors.blue),
            _BoundingBox(left: 270, top: 310, width: 40, height: 80, label: 'Plastic', color: Colors.blue),
            _BoundingBox(left: 100, top: 400, width: 180, height: 40, label: 'Metal Pipe', color: Colors.orange),
          ],
...
class _BoundingBox extends StatelessWidget {
  ...
  const _BoundingBox({required this.left, required this.top, required this.width, required this.height, required this.label, required this.color});
