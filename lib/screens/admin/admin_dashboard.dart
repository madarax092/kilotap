                  ...
                  Container(
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            const _Bar('Pickups', 47, 50, '47/day',
                                AppColors.buyerBlue),
                            const _Bar('New Users', 12, 30, '12/day',
                                AppColors.buyerBlue),
                            const _Bar('Reports', 3, 20, '3/week',
                                AppColors.buyerBlue),
                            const _Bar('Avg Rating', 4.6, 5.0, '4.6 ★',
                                AppColors.star),
                          ])),
                      ...
                      child: Column(
                          ...
                          children: [
                            ...
                            const _ReportCard(
                                ...
                                'Investigate',
                                AppColors.warning,
                                'Collector no-show for #PKP-0035',
                                'Maria S. · June 29'),
                            const Divider(height: 24, color: Color(0xFFF3F4F6)),
                            const _ReportCard(
                                '#RPT-0017',
