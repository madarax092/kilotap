    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const _Field(label: 'Full Name', value: 'Maria Santos'),
          const _Field(label: 'Phone Number', value: '+63917XXXXXXX'),
          const _Field(label: 'Email', value: 'maria@email.com'),
          const _Field(label: 'Address', value: 'Block 5, Lot 12, Barangay Maa, Davao City'),
