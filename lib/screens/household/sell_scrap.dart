...
class _SellScrapScreenState extends State<SellScrapScreen> {
          ...
          Expanded(
            child: ListView(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () async {
                      final result = await Navigator.push(context, MaterialPageRoute(builder: (_) => const CameraPrototypeScreen()));
                          ...
                          children: [
                            Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    color:
                                        AppColors.sellerGreen.withOpacity(0.08)),
                    ...
                    _Card(children: const [
                      Center(
                        child: Padding(
                          ...
                          child: Text('Take a photo to generate AI analysis.', style: TextStyle(color: Color(0xFF6B7280), fontSize: 13)),
                        ),
                      )
                    ])
                  else
                  ...
                  SizedBox(
                      ...
                      child: ElevatedButton(
                          style: ElevatedButton.styleFrom(
                              ...
                              disabledBackgroundColor: AppColors.sellerGreen.withOpacity(0.3),
                              disabledForegroundColor: Colors.white.withOpacity(0.5),
                              elevation: 0,
                              shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(16))),
                          onPressed: _detections.isEmpty ? null : () {
  ...
  List<Widget> _buildAnalysisRows() {
    ...
    counts.forEach((key, count) {
      ...
      rows.add(_AnalysisRow(label, '$count pc${count > 1 ? 's' : ''}', '$sizeClass · $totalWeight kg'));
    });
