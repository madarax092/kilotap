        ...
        builder: (context, setState) => Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 24),
              const Text('Rate your pickup', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w800, color: Color(0xFF111827))),
              const SizedBox(height: 8),
              Text('How was your experience with $collectorName?', textAlign: TextAlign.center, style: const TextStyle(color: Color(0xFF6B7280), fontSize: 14)),
              const SizedBox(height: 24),
              Row(
                ...
                children: List.generate(5, (index) {
                  return IconButton(
                    ...
                    icon: Icon(
                      ...
                      color: index < rating ? AppColors.star : const Color(0xFFE5E7EB),
                    ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('SUBMIT RATING', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 14, letterSpacing: 0.5)),
                ),
              ),
            ],
          ),
      ...
      builder: (ctx) => Container(
        ...
        child: Column(
          ...
          children: [
            Container(width: 40, height: 4, decoration: BoxDecoration(color: const Color(0xFFE5E7EB), borderRadius: BorderRadius.circular(2))),
            const SizedBox(height: 24),
            const Text('Reschedule Pickup', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w800, color: Color(0xFF111827))),
            const SizedBox(height: 8),
            Text('Select a new time for $bookingId', textAlign: TextAlign.center, style: const TextStyle(color: Color(0xFF6B7280), fontSize: 14)),
            const SizedBox(height: 24),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: const Text('CONFIRM', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 14, letterSpacing: 0.5)),
              ),
            ),
          ],
        ),
      ...
      builder: (ctx) => Container(
        ...
        child: Column(
          ...
          children: [
            Container(width: 40, height: 4, decoration: BoxDecoration(color: const Color(0xFFE5E7EB), borderRadius: BorderRadius.circular(2))),
            const SizedBox(height: 24),
            const Text('Report Issue', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w800, color: Color(0xFF111827))),
            const SizedBox(height: 8),
            Text('What was the issue with $collectorName?', textAlign: TextAlign.center, style: const TextStyle(color: Color(0xFF6B7280), fontSize: 14)),
            const SizedBox(height: 24),
            TextField(
              maxLines: 4,
              decoration: InputDecoration(
                ...
                border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: Color(0xFFE5E7EB))),
                enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: Color(0xFFE5E7EB))),
                focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: AppColors.error)),
              ),
            ),
            const SizedBox(height: 24),
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: const Text('SUBMIT REPORT', style: TextStyle(fontWeight: FontWeight.w800, fontSize: 14, letterSpacing: 0.5)),
              ),
            ),
          ],
        ),
