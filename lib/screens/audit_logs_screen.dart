                  ...
                  child: Column(
                    ...
                    children: const [
                      ...
                      _Audit(
                        ...
                        targetId: '#PKP-0042',
                        description: 'Collector accepted pickup request from Maria Santos.',
                      ...
                      _Audit(
                        ...
                        description: 'Admin verified collector Pedro Reyes and activated account.',
                      ...
                      _Audit(
                        ...
                        targetId: '#RPT-0017',
                        description: 'Investigated and resolved report #RPT-0017 (wrong items).',
                      ...
                      _Audit(
                        ...
                        targetId: 'User #A3X92',
                        description: 'Automated suspension due to 3 consecutive no-show violations.',
...
class _Audit extends StatelessWidget {
  final String logId, actorId, action, targetId, description, createdAt, ipAddress;
        ...
        children: [
          Row(
            ...
            children: [
              Text(
                'Log ID: $logId',
                style: const TextStyle(fontSize: 10, color: Color(0xFF9CA3AF), fontWeight: FontWeight.w700)
              ),
              Text(
                createdAt,
                style: const TextStyle(fontSize: 10, color: Color(0xFF9CA3AF), fontWeight: FontWeight.w700)
