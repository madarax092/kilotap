...
class RequestDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final args = {
      ...
      'imagePath': rawArgs['imagePath'] ?? 'assets/images/multiple_scrap_sample.png',
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Request Details', style: TextStyle(color: Color(0xFF111827), fontWeight: FontWeight.w800, fontSize: 16)),
                ...
                Row(
                  children: [
                    Container(
                      ...
                      child: Center(child: Text(args['initials'], style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16))),
                    ),
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(args['name'], style: const TextStyle(fontWeight: FontWeight.w800, fontSize: 16, color: Color(0xFF111827))),
                          const SizedBox(height: 2),
                          Text(args['location'], style: const TextStyle(fontSize: 13, color: Color(0xFF6B7280))),
                        ],
                      ),
                    ),
                    Container(
                      ...
                      child: Text(args['time'], style: const TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: AppColors.error)),
                    ),
                  ],
                ),
                    ...
                    children: const [
                      ...
                      Expanded(
                        child: Text(
                          ...
                          style: TextStyle(fontSize: 13, color: Color(0xFF4B5563), fontStyle: FontStyle.italic),
                        ),
                      ),
                    ],
                  ),
            ...
            Row(
              ...
              Expanded(
                child: ElevatedButton.icon(
                  ...
                  label: const Text('Accept', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16)),
                  ...
                  onPressed: () {
                    ...
                    Navigator.pushReplacementNamed(context, '/collector_nav', arguments: args);
                  },
                ),
              ),
              ...
              Expanded(
                child: OutlinedButton.icon(
                  ...
                  label: const Text('Decline', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 16)),
...
class _DetailCol extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text(val, style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w800, color: Color(0xFF111827))),
